...
#SBATCH --job-name=graph_training                 # Job name
#SBATCH --output=logs/graph_training_%j.out      # Standard output log (%j will be replaced by the job ID)
#SBATCH --error=logs/graph_training_%j.err        # Standard error log
