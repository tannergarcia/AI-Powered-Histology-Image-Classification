...
const PredictionsPage = () => {
  ...
  const { result, image_url } = location.state || {};
  ...
  const displayedImageWidth = 320; // w-80 => 20rem => 320px
  const displayedImageHeight = 320; // h-80 => 20rem => 320px
      ...
      <div className="relative min-h-screen backdrop-blur-xl flex flex-col">
        ...
        <div className="flex-1 flex flex-col items-center justify-center px-4 py-24">
          <div className="max-w-5xl w-full text-center">
            ...
            {/* Divider */}
            <div className="my-16 w-full h-px bg-gradient-to-r from-blue-500 via-purple-500 to-blue-500"></div>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
              <button
                onClick={() => navigate('/')}
                className="bg-gradient-to-r from-blue-500 to-purple-500 hover:from-blue-600 hover:to-purple-600 text-white px-8 py-4 rounded-xl text-xl font-semibold transition-all duration-300 transform hover:scale-105 focus:outline-none focus:ring-4 focus:ring-purple-500"
              >
                Analyze Another Sample
              </button>
              <button
                onClick={() => window.print()}
                className="border border-gray-500 hover:border-gray-400 text-gray-300 hover:text-white px-8 py-4 rounded-xl text-xl font-semibold transition-all duration-300 transform hover:scale-105 focus:outline-none focus:ring-4 focus:ring-gray-500"
              >
                Download Report
              </button>
            </div>
